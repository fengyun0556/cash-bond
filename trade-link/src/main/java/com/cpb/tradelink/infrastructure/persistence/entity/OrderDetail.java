...
public class OrderDetail {
    ...
    @Column(name = "CASH_ACCOUNT_CURRENCY", length = 10)
    ...
    @Column(name = "ISIN_TYPE", length = 10)
    ...
    @Column(name = "COMMISSION_RATE", precision = 20, scale = 4)
    private BigDecimal commissionRate;

    @Column(name = "COMMISSION_TYPE", length = 20)
    private String commissionType;

    @Column(name = "COMMISSION_PRICE", precision = 20, scale = 4)
